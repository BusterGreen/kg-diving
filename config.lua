Config = Config or {}
Config.UseTarget = GetConvar('UseTarget', 'false') == 'true' -- Use kg-target interactions (don't change this, go to your server.cfg and add `setr UseTarget true` to use this and just that from true to false or the other way around)
